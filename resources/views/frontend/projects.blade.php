        ...
        <div class="rounded-3 border border-1 position-relative overflow-hidden">
            <div class="box-linear-animation position-relative z-1">
                                            ...
                                            <div class="row">
                                                <div class="col-lg-5">
                                                    <img class="w-100"
                                                        ...
                                                        alt="zelio" />
                                                    <!-- <img class="w-100"
                                                        src="{{ asset('assets/imgs/home-page-2/projects/img-1.png') }}"
                                                        alt="zelio" /> -->
                                                </div>
                                                <div class="col-lg-7 ps-lg-5 mt-5 mt-lg-0">
                                                    ...
                                                    <ul class="mt-4 list-unstyled">
                                                        <li class="text-secondary-2 mb-3 border-bottom pb-3">Project Info
                                                        </li>
                                                        ...
                                                        <li class="text-dark mb-3 border-bottom pb-3">
                                                            <div class="d-flex justify-content-between">
                                                                ...
                                                                <p class="text-300 mb-0 text-end">{{ $project->completion_time }}</p>
                                                            </div>
                                                        </li>
                                                        <li class="text-dark mb-3 border-bottom pb-3">
                                                            <div class="d-flex justify-content-between">
                                                                <p class="text-dark mb-0 text-end">Technologies</p>
                                                                <p class="text-300 mb-0 text-end">{{ $project->technology }}</p>
                                                            </div>
                                                        </li>
                                                    </ul>
                                                    <div class="d-flex flex-wrap align-items-center gap-3 mt-7">
                                                        <a href="{{ $project->project_demo }}" target="_blank"
                ...
                <img class="position-absolute top-0 start-0 z-0"
                    src="{{ asset('assets/imgs/home-page-2/projects/bg.png') }}" alt="zelio" />
            </div>
        </div>
    </div>
</section>
