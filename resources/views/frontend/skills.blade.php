                                            ...
                                            <ul class="carouselTicker__list m-0">
                                                <li class="carouselTicker__item mt-6">
                                                    <a href="#" class="brand-logo icon_80 icon-shape rounded-3">
                                                        <img src="{{ asset('assets/imgs/home-page-2/hero-1/icon-4.svg') }}"
                                                            alt="brand" />
                                                    </a>
                                                ...
                                                <li class="carouselTicker__item mt-6">
                                                    <a href="#" class="brand-logo icon_80 icon-shape rounded-3">
                                                        <img src="{{ asset('assets/imgs/home-page-2/hero-1/icon-1.svg') }}"
                                                            alt="brand" />
                                                    </a>
                                                ...
                                                <li class="carouselTicker__item mt-6">
                                                    <a href="#" class="brand-logo icon_80 icon-shape rounded-3">
                                                        <img src="{{ asset('assets/imgs/home-page-2/hero-1/icon-2.svg') }}"
                                                            alt="brand" />
                                                    </a>
                                                ...
                                                <li class="carouselTicker__item mt-6">
                                                    <a href="#" class="brand-logo icon_80 icon-shape rounded-3">
                                                        <img src="{{ asset('assets/imgs/home-page-2/hero-1/icon-3.svg') }}"
                                                            alt="brand" />
                                                    </a>
                                                ...
                                                <li class="carouselTicker__item mt-6">
                                                    <a href="#" class="brand-logo icon_80 icon-shape rounded-3">
                                                        <img src="{{ asset('assets/imgs/home-page-2/hero-1/icon-6.svg') }}"
                                                            alt="brand" />
                                                    </a>
                                    ...
                                    <div class="col-lg-8 col-md-7 col-10 mx-auto overflow-hidden">
                                        ...
                                        <div class="carouselTicker carouselTicker-left position-relative z-1">
                                            <ul class="carouselTicker__list m-0 ">
                                                <li class="carouselTicker__item mt-6">
                                                    <a href="#" class="brand-logo icon_80 icon-shape rounded-3">
                                                        <img src="{{ asset('assets/imgs/home-page-2/hero-1/icon-7.svg') }}"
                                                            alt="brand" />
                                                    </a>
                                                ...
                                                <li class="carouselTicker__item mt-6">
                                                    <a href="#" class="brand-logo icon_80 icon-shape rounded-3">
                                                        <img src="{{ asset('assets/imgs/home-page-2/hero-1/icon-8.svg') }}"
                                                            alt="brand" />
                                                    </a>
                                                ...
                                                <li class="carouselTicker__item mt-6">
                                                    <a href="#" class="brand-logo icon_80 icon-shape rounded-3">
                                                        <img src="{{ asset('assets/imgs/home-page-2/hero-1/icon-9.svg') }}"
                                                            alt="brand" />
                                                    </a>
                                                ...
                                                <li class="carouselTicker__item mt-6">
                                                    <a href="#" class="brand-logo icon_80 icon-shape rounded-3">
                                                        <img src="{{ asset('assets/imgs/home-page-2/hero-1/icon-5.svg') }}"
                                                            alt="brand" />
                                                    </a>
            ...
            <div class="position-absolute d-none d-md-block decorate">
                <div class="rotateme">
                    ...
                    <div class="circle-1-2 position-absolute top-50 start-50 translate-middle">
                        <svg class="mb-5 position-absolute bottom-0 start-0" xmlns="http://www.w3.org/2000/svg"
                            width="9" height="9" viewBox="0 0 9 9" fill="none">
                            <circle cx="4.5" cy="4.5" r="4.5" fill="#636366" />
                        </svg>
                    </div>
                    <div class="circle-1-3 position-absolute top-50 start-50 translate-middle ">
                        <svg class="mb-3 position-absolute bottom-0 end-0" xmlns="http://www.w3.org/2000/svg" width="9"
