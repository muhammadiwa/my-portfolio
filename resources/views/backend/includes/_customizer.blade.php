                    ...
                    <div class="form-check form-check-inline with-layout-image m-0">
                        ...
                        <label class="form-label mb-0" for="verticalNav">
                            <span class="d-inline-block mb-2">
                                <img class="light-version img-fluid rounded-1" src="{{ asset('public/back/assets/img/customizer/vertical-light.png') }}" alt="img">
                                <img class="dark-version img-fluid rounded-1" src="{{ asset('public/back/assets/img/customizer/vertical-dark.png') }}" alt="img">
                            </span>
                ...
                <div class="col-4">
                    <div class="form-check form-check-inline with-layout-image m-0">
                        ...
                        <label class="form-label mb-0" for="horizontalNav">
                            <span class="d-inline-block mb-2">
                                <img class="light-version img-fluid rounded-1" src="{{ asset('public/back/assets/img/customizer/horizontal-light.png') }}" alt="img">
                                <img class="dark-version img-fluid rounded-1" src="{{ asset('public/back/assets/img/customizer/horizontal-dark.png') }}" alt="img">
                            </span>
                ...
                <div class="col-4">
                    <div class="form-check form-check-inline with-layout-image m-0">
                        ...
                        <label class="form-label mb-0" for="comboNav">
                            <span class="d-inline-block mb-2">
                                <img class="light-version img-fluid rounded-1" src="{{ asset('public/back/assets/img/customizer/combo-light.png') }}" alt="img">
                                <img class="dark-version img-fluid rounded-1" src="{{ asset('public/back/assets/img/customizer/combo-dark.png') }}" alt="img">
                            </span>
            ...
            <div class="row">
                <div class="col-4">
                    <div class="form-check form-check-inline with-layout-image m-0">
                        ...
                        <a href="{{ asset('public/back/index-2.html') }}" target="_blank" rel="noopener noreferrer" class="fs-14 fw-semibold text-dark">
                                <span class="d-inline-block mb-2">
                                    <img class="light-version img-fluid rounded-1" src="{{ asset('public/back/assets/img/customizer/vertical-light.png') }}" alt="img">
                                    <img class="dark-version img-fluid rounded-1" src="{{ asset('public/back/assets/img/customizer/vertical-dark.png') }}" alt="img">
                                </span>
                ...
                <div class="col-4">
                    <div class="form-check form-check-inline with-layout-image m-0">
                        <label class="form-label mb-0">
                        <a href="{{ asset('public/back/index-horizontal.html') }}" target="_blank" rel="noopener noreferrer" class="fs-14 fw-semibold text-dark">
                                <span class="d-inline-block mb-2">
                                    <img class="light-version img-fluid rounded-1" src="{{ asset('public/back/assets/img/customizer/horizontal-light.png') }}" alt="img">
                                    <img class="dark-version img-fluid rounded-1" src="{{ asset('public/back/assets/img/customizer/horizontal-dark.png') }}" alt="img">
                                </span>
                ...
                <div class="col-4">
                    <div class="form-check form-check-inline with-layout-image m-0">
                        <label class="form-label mb-0">
                        <a href="{{ asset('public/back/index-combo.html') }}" target="_blank" rel="noopener noreferrer" class="fs-14 fw-semibold text-dark">
                                <span class="d-inline-block mb-2">
                                    <img class="light-version img-fluid rounded-1" src="{{ asset('public/back/assets/img/customizer/combo-light.png') }}" alt="img">
                                    <img class="dark-version img-fluid rounded-1" src="{{ asset('public/back/assets/img/customizer/combo-dark.png') }}" alt="img">
                                </span>
