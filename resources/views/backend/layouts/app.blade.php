...
<!-- Mirrored from eres.dexignzone.com/xhtml/ by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 29 Nov 2023 14:25:16 GMT -->
<head>
	...
	<link href="{{asset('public/back/vendor/owl-carousel/owl.carousel.css')}}" rel="stylesheet">
    <link href="{{asset('public/back/vendor/bootstrap-select/dist/css/bootstrap-select.min.css')}}" rel="stylesheet">
	
	<!-- Style Css --> 
	<link class="main-css" href="{{asset('public/back/css/style.css')}}" rel="stylesheet">
    ...
    ***********************************-->
    <div id="main-wrapper">
        ...
        ***********************************-->
        <div class="nav-header">
            <a href="index-2.html" class="brand-logo">
             <svg class="logo-abbr" width="52" height="52" viewBox="0 0 52 52" fill="none" xmlns="../../www.w3.org/2000/svg.html">
				...
				<svg class="brand-title" width="87" height="27" viewBox="0 0 87 27" fill="none" xmlns="../../www.w3.org/2000/svg.html">
                        ...
                        <ul class="navbar-nav header-right">
                            <li class="nav-item dropdown notification_dropdown">
                                <a class="nav-link  ai-icon" href="javascript:;" role="button" data-bs-toggle="dropdown">
                                    <svg width="25" height="25" viewBox="0 0 26 26" fill="none" xmlns="../../www.w3.org/2000/svg.html">
							...
							<li class="nav-item dropdown notification_dropdown">
                                <a class="nav-link bell bell-link ai-icon" href="javascript:;">
                                    <svg width="23" height="28" viewBox="0 0 23 22" fill="none" xmlns="../../www.w3.org/2000/svg.html">
							...
							<li class="nav-item dropdown notification_dropdown">
                                <a class="nav-link ai-icon" href="javascript:;"  role="button" data-bs-toggle="dropdown">
                                    <svg class="svg-multi-color"width="25" height="25" viewBox="0 0 26 26" fill="none" xmlns="../../www.w3.org/2000/svg.html">
								...
								<div class="media align-items-center">
									<div class="media-body">
										...
										<div class="d-flex flex-wrap">
											...
											<div>	
												<svg width="28" height="19" viewBox="0 0 28 19" fill="none" xmlns="../../www.w3.org/2000/svg.html">
									...
									<span class="border rounded-circle p-4">
										<svg width="34" height="34" viewBox="0 0 34 34" fill="none" xmlns="../../www.w3.org/2000/svg.html">
						...
						<div class="card gradient-bx text-white bg-success">	
							<div class="card-body">
								<div class="media align-items-center">
									...
									<span class="border rounded-circle p-4">
										<svg width="34" height="34" viewBox="0 0 38 38" fill="none" xmlns="../../www.w3.org/2000/svg.html">
        ...
        ***********************************-->
        <div class="footer">
            <div class="copyright">
                <p>Copyright © Designed &amp; Developed by <a href="../../dexignzone.com/index.html" target="_blank">DexignZone</a> 2023</p>
            </div>
        </div>
        <!--**********************************
            Footer end
...
<!-- Mirrored from eres.dexignzone.com/xhtml/ by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 29 Nov 2023 14:27:00 GMT -->
</html>